...
public class RocketSensorScreen extends AddonMachineScreen<RocketSensorBlockEntity, RocketSensorMenu>
{
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY)
	{
		...
		this.font.draw(poseStack, Component.translatable(CURRENT_KEY, rocketSensor.getAnalogSignal()), this.titleLabelX, this.invertedCheckBox.y + this.invertedCheckBox.getHeight() + 8 - this.topPos, this.getTextColour());
